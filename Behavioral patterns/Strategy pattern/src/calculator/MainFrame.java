...
public class MainFrame extends JFrame {
		...
		btnCalc.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (operator.equals("+")) {
					...
					rezDisplay.append(a + " " + cmbOperator.getSelectedItem().toString() + b + " = "
							+ sc.performCalculation(a, b) + "\n");
	...
	private void runLayout() {
		...
		gc.gridy = 3;
		// gc.gridheight=5;
		rightP.add(new JScrollPane(rezDisplay, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
